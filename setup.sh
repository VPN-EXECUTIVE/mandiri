...
wget https://raw.githubusercontent.com/VPN-EXECUTIVE/mandiri/master/cf && chmod +x cf && ./cf
...
sleep 0.5
clear
wget https://raw.githubusercontent.com/VPN-EXECUTIVE/mandiri/master/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
wget https://raw.githubusercontent.com/VPN-EXECUTIVE/mandiri/master/insshws.sh && chmod +x insshws.sh && ./insshws.sh
clear
...
echo "--------------------------VPN-EXECUTIVE-----------------------------" | tee -a log-install.txt
echo "==================================================================" | tee -a log-install.txt
echo -e ""
echo ""
echo "" | tee -a log-install.txt
