...
#
wget -q -O /usr/local/bin/geosite.dat "https://raw.githubusercontent.com/VPN-EXECUTIVE/mandiri/master/grpc/menu/geosite.dat"
wget -q -O /usr/local/bin/geoip.dat "https://raw.githubusercontent.com/VPN-EXECUTIVE/mandiri/master/grpc/ma/geoip.dat"
